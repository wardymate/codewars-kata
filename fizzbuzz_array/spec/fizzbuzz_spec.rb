...
describe Fizzbuzz do
  ...
  it 'should return an array of 100 numbers' do
    ...
    expect(fizzer.fizz_buzz_custom).to eq output
  end

  it 'should return fizz for all multiples of 3' do
    expect(fizzer.fizz_buzz_custom[2]).to eq "Fizz"
  end
